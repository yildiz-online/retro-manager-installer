...
int main () {
    ...
    downloadFile("play50hz-manager.jar", "http://files.yildiz-games.be/play50hz/launcher/manager-launcher.jar");
...
void runApp() {
    std::string cmd = "\"" + workingdir() +  "/" + javaFile + "\"" + " -jar play50hz-manager.jar";
    system(cmd.c_str());
}
